...
export const CharacterDetails = (): JSX.Element => {
  ...
  return (
    <>
      {byID.status === "error" ? (
        <Text type="danger">
          Wow this is embarrassing... the character you are looking for does not
          exist. <Link onClick={() => navigate("/")}>Back to list</Link>
        </Text>
      ) : null}
      {byID.isLoading ? (
        <Col>Loading...</Col>
              ...
              <div key={item.id}>
                ...
                <>
                  ...
                  {item.name ? (
                    ...
                    <Typography>Oops, where is not data available</Typography>
                  )}
                  {item.description ? (
